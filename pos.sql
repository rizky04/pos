...
-- Dumping database structure for soto
CREATE DATABASE IF NOT EXISTS `soto` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `soto`;
...
-- Dumping data for table soto.cache: ~3 rows (approximately)
...
-- Dumping data for table soto.migrations: ~38 rows (approximately)
...
-- Dumping data for table soto.sales: ~0 rows (approximately)
...
-- Dumping data for table soto.sales_items: ~0 rows (approximately)
...
-- Dumping data for table soto.sales_payments: ~0 rows (approximately)
...
-- Dumping data for table soto.sessions: ~0 rows (approximately)
...
-- Dumping data for table soto.stok_opname_logs: ~0 rows (approximately)
...
-- Dumping data for table soto.stok_transactions: ~0 rows (approximately)
...
-- Dumping data for table soto.suppliers: ~0 rows (approximately)
...
-- Dumping data for table soto.tbl_barang: ~0 rows (approximately)
...
-- Dumping data for table soto.tbl_client: ~0 rows (approximately)
...
-- Dumping data for table soto.tbl_pembelian: ~0 rows (approximately)
...
-- Dumping data for table soto.tbl_pengguna: ~0 rows (approximately)
...
-- Dumping data for table soto.tbl_penjualan: ~0 rows (approximately)
...
-- Dumping data for table soto.tbl_transaksi: ~0 rows (approximately)
...
-- Dumping data for table soto.tenants: ~0 rows (approximately)
...
-- Dumping data for table soto.units: ~0 rows (approximately)
...
-- Dumping data for table soto.users: ~0 rows (approximately)
