...
<head>
    ...
    body { background: #fff; font-family: 'Courier New', monospace; font-size: 11px; line-height: 1.3; }
    .invoice-wrapper { width: 80mm; margin: 10px auto; padding: 10px; border: 1px solid #eee; background: #fff; }
